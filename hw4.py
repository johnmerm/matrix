...
lin_dep_R_1 = [-2,1,1]
lin_dep_R_2 = [-4,1,-4/7]
lin_dep_R_3 = [ -4.156361, -0.235105, 0.026302,1,1 ] 
...
linear_dep_R_1 = [-0.3,0.3,-0.9]
linear_dep_R_2 = [1,1/(2*pi),1/(2*sqrt(2))]
